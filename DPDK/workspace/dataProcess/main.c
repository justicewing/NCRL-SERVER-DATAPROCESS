...
static int package_to_mbuf(struct package_t *package, uint8_t *buff);
static int buff_to_package(struct package_t *package, unsigned char *databuff);
...
l2fwd_main_p(void)
{
	...
	{
		package_tx.tbs[i] = i * 100;
		package_tx.CQI_index[i] = i;
	}
